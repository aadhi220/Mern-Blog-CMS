import {
  ...
  import { addBlogApi, editBlogApi, getAllCategoryApi, getUserByIdApi } from "../../Services/AllAPI";
  ...
  const HandleSubmit =async (e)=>{
    e.preventDefault();
    const {title,caption,category,images,created_at,content,blogId}=blogDetails;
      ...
      <div className="p-[1rem] dark:bg-[#111827]">
        <div className="w-full ">
          <div id="header" className="my-[1rem]">
            <div>
              <h1 className="text-2xl font-semibold dark:text-white">Edit Blog</h1>
            </div>
          </div>
